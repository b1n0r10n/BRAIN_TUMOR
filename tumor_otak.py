...
import os
import pandas as pd  # Untuk visualisasi dan opsi download
...
# 3. Fungsi Prediksi
# ==========================================
def predict_lung_cancer(img: Image.Image):
    """
    Menerima input berupa PIL Image, melakukan preprocessing,
    lalu mengembalikan label, probabilitas kelas terprediksi, dan prediksi lengkap.
    """
    try:
...
# ==========================================
# 4. Streamlit App dengan Navigasi, Visualisasi, dan Opsi Download
# ==========================================
    ...
    try:
        ...
        if st.button("Predict"):
            with st.spinner("Memproses..."):
                label, prob, preds = predict_lung_cancer(image_pil)
